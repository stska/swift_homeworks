...
extension GameScene: SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        case collisionCategories.Apple:
            ...
            createApple()
    //---------------------------------------------------------------------------------------------------
        //Со столкновение стены работает, но на саму себя не регирует, просьба выложите потом к 8 уроку, как должен выглядить правильный код, спасибо ^^
        ...
        case collisionCategories.Snake:
            ...
            let check = contact.bodyA.node is Snake ? false : true
